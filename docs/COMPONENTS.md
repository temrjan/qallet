...
└──────────────────────────┬──────────────────────────────────────┘
         ...
         └──┬──────┬──────┬──────┬──────┬─────┘
            │      │      │      │      │
     ┌──────▼┐ ┌───▼───┐ ┌▼─────┐ ┌────▼──┐ ┌──▼──────┐ ┌────▼───┐
     │KEYRING│ │PROVIDER│ │ROUTER│ │TXGUARD│ │EXPLAINER│ │EXPLORER│
     │       │ │       │ │      │ │       │ │         │ │        │
     │ключи  │ │RPC ко │ │маршру│ │защита │ │AI       │ │история │
     │подпись│ │всем   │ │тизация│ │транзак│ │объяснен.│ │транзакц│
     │       │ │сетям  │ │      │ │ций    │ │         │ │        │
     └───────┘ └───────┘ └──┬───┘ └───────┘ └─────────┘ └────────┘
                            │
                    ┌───────▼───────┐
...
**Зависимости:** keyring, provider, router, txguard, explorer, explainer
...
**Технология:** Leptos 0.8 (full Rust → WASM) + Tailwind CSS
...
- **wallet-web** — Leptos 0.8 (выбран). Full Rust stack, shared types с core
